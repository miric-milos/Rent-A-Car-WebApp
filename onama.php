...
<!-- NAV END -->
    ...
    <h1 class="text-center mt-3" id="naslov">O nama</h1>
    <hr>
    <div class="container-fluid">
        <div class="row mb-5">
            <div class="col-md-6"><img class="oNamaSlike" src="img/onama/oNamaImg1.jpg" alt="" width="95%"></div>
            <div class="col-md-6 mt-5">
                <p>Renta a car VISER ima odličan odnos cene i kvaliteta. Mi se nalazimo u Beogradu, tačnije na Novom
                    Beogradu.</p>
                <p>Sva naša vozila su potpuno ispravna i redovno servisirana, ne morate razmišljati o tome da li je auto
                    ispravan ili ne.</p>
                <p>Sva vozila su potpuno sigurna i opremljena GPS uređem (opciono), tako da možete biti sasvim sigurni
                    da se nećete
                    izgubiti.</p>
            </div>
        </div>
        ...
        <div class="row mt-5 mb-5">
            <div class="col-md-6">
                ...
                <p>Ukoliko želite vozilo da iznajmite na duži vremenski period, recimo više meseci Bel rent a car
                    Beograd vam nudi posebne
                    cene i pogodnosti, pozovite nas, nećete se pokajati.</p>
            </div>
            <div class="col-md-6"><img src="img/onama/oNamaImg2.jpg" class="oNamaSlike" width="100%" alt=""></div>
        </div>
        <hr>
        <div class="row mt-5">
            <div class="col-md-6"><img src="img/onama/oNamaImg3.jpg" class="oNamaSlike" width="100%" alt=""></div>
            <div class="col-md-6">
                <p>Putovanje avionom više nije samo stvar luksuza. Zahvaljujući low cost letovima i ubrzanom razvoju
                    avio saobraćaja, sve
                    je više građana koji sebi mogu priuštiti putovanje ovim prevoznim sredstvom. Verovali ili ne, avion
                    je najbezbednije
                    prevozno putničko sredstvo.</p>
            </div>
        </div>
    </div>
    <!-- Nav End -->
...
<div class="modal fade" tabindex="-1" id="loginModal" role="dialog">
    ...
    <script type="text/javascript" src="js/oNama.js"></script>
</body>
