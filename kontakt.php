...
<head>
    ...
    <script src="js\prikazLokacija.js"></script>
...
<body>
    ...
    <h1 class="display-4 text-center text-light pt-3 pb-5"
        style="font-size: 45px;">Lokacije</h1>


    <div id="lokacije" class="container">

    </div>

    <hr class="bg-light m-5">

    <div id="kontakt" class="container kontanktDiv mb-5">
        <h1 class="display-4 text-center pt-3 pb-5 text-light"
            style="font-size: 45px;">Kontaktirajte nas</h1>
        <input class="form-control col-md-6" type="email" id="email" name="email" placeholder="E-Mail Adresa...">
        <br>        
        <input class="form-control col-md-6" type="text" id="tema" name="tema" placeholder="Tema...">
        <br>
        <textarea class="form-control" name="tekst" id="tekst" rows="10" placeholder="Pitanje..."></textarea><br>
        <button class="btn btn-lg mb-5" id="posalji">Pošalji</button>
    </div>

    <div id="iframe-container" class="m-md-5">
        <iframe class="location-iframe"
            src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d45310.86691737954!2d20.463171711640832!3d44.782249076448934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1scar%20rental!5e0!3m2!1sen!2srs!4v1573993650774!5m2!1sen!2srs"
            width="600" height="650" frameborder="0" style="border:0;" allowfullscreen="true"></iframe>
    </div>

    <!--Modal-->
    <div class="modal" tabindex="-1" id="modalKontakt" role="dialog">
