...
<body>
<div class="modal fade" tabindex="-1" id="rezervacijaModal" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="index.php" type="button" class="btn btn-secondary">Nazad na početnu</a>
            </div>
        </div>
    </div>
</div>
...
<?php
    if(isset($_POST['ukupnaCena'])){
        $rezervacija=array("id_naloga"=>$ulogovan['id_naloga'],"id_auto"=>$_GET['id_auto'],"datum_od"=>$_POST['datumOd'],"datum_do"=>$_POST['datumDo'],"cena"=>$_POST['ukupnaCena']);
        $poruka=Baza::unesi_rezervacije($rezervacija);
        echo '<script type="text/javascript">
                $("#rezervacijaModal").modal({
                    keyboard: false,
                    backdrop: "static"
                });
                console.log("Udjoh 1");
                prikazPoruke("Rezervacija","'.$poruka. '","rezervacijaModal")
                </script>';
        ...
        <div class="card mt-3">
            <div class="row">
                <div class="col-lg-6">
                    <?php
                        if(isset($_GET['id_auto'])){
                            $auto=Baza::odabraniAuto($_GET['id_auto'])[0];
                            echo "<img class='card-img' height='100%' src='img/automobili/".$auto['putanja_slike']."' alt='izabranAuto'>";
                        }
                    ?>
                </div>
                <div class="col-lg-6">
                    <div class="row mt-sm-0 ml-2 mt-lg-2" id="prikaz">
                        <?php
                            echo "
                                <div class=\"col-6 col-lg-4\">
                                    <p>Marka: <b id=\"marka\">".$auto['marka']."</b></p>
                                    <p>Model: <b id=\"model\">".$auto['model']."</b></p>
                                    <p>Godište: <b id=\"godiste\">".$auto['godiste']."</b></p>
                                </div>
                                <div class=\"col-6 col-lg-4\">
                                    <p>Kubikaža: <b id='kubikaza'>".$auto['kubikaza']."</b></p>
                                    <p>Karoserija: <b id='karoserija'>".$auto['karoserija']."</b></p>
                                    <p>Gorivo: <b id='gorivo'>".$auto['gorivo']."</b></p>
                                </div>
                                <div class='col-lg-4'>
                                    <p>Pogon: <b id='pogon'>".$auto['pogon']."</b></p>
                                    <p>Menjač: <b id='menjac'>".$auto['menjac']."</b></p>
                                    <p>Broj vrata: <b id='broj_vrata'>".$auto['broj_vrata']."</b></p>
                                </div>"
                        ?>

                    </div>
                    <hr>
                    <?php echo '<p class="ml-4">Cena po danu: <b id="cena_po_danu">'.$auto['cena_po_danu'].' €</b></p>' ?>
                    <i class="ml-4 bg-warning">Auto možete rezervisati najviše na 15 dana</i>
                    <?php echo '<form id="formaRezervacija" method="post" action="rezervacija.php?id_auto='.$_GET['id_auto'].'" class="ml-3">'; ?>
                        <label for="datumOd" class="mt-3"><b>Datum od</b></label>
                        <input type="text" id="datumOd" name="datumOd" class="form-control">
                        <label for="datumDo" class="mt-3"><b>Datum do</b></label>
                        <input type="text" id="datumDo" name="datumDo" class="form-control">
                        <div class="mt-3">
                            <label for="ukupnaCena"><b>Ukupna cena:</b></label>
                            <input type="text" id="ukupnaCena" name="ukupnaCena" class="border-0 ml-3" value="0€" readonly></b>
                            <button type="button" class="btn btn-warning mr-3" id="btnRezervisi" style="float: right">Rezerviši</button>
                        </div>
